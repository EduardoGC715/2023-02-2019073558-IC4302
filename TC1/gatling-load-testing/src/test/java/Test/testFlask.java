...
public class testFlask extends Simulation {
        // Http Protocol
        HttpProtocolBuilder httpProtocol = http.baseUrl("http://127.0.0.1:53347")
        ...
        private static ChainBuilder getAllPokemon = exec(http("Get all Pokemon")
                        .get("/getAllPokemon"));

        private static ChainBuilder getPokemonId = feed(jsonFeeder)
        ...
        private static ChainBuilder addPokemon = feed(jsonFeeder)
        ...
        private static ChainBuilder updatePokemon = feed(jsonFeeder)
        ...
        private static ChainBuilder deleteLastPostedPokemon = feed(jsonFeeder)
        ...
        {
                setUp(
                                scn.injectOpen(rampUsers(10).during(30))).protocols(httpProtocol).maxDuration(900);
        }
}
